# User Credentials - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** User Credentials
**Category:** Injection
**Difficulty:** ⭐⭐⭐⭐ (4/6)
...
This challenge demonstrates injection vulnerabilities in a real-world web application context. Retrieve a list of all user credentials via SQL Injection
...
#!/usr/bin/env python3
"""
Automated solver for: User Credentials
Category: Injection
"""
...
def solve_challenge():
    """Automated solution for User Credentials"""

    print(f"[*] Starting challenge: User Credentials")

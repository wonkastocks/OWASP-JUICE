# Login Admin (SQL) - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Login Admin (SQL)
**Category:** Injection
**Difficulty:** ⭐⭐ (2/6)
**Description:** Log in with the administrator's user account using SQL Injection
...
This challenge demonstrates injection vulnerabilities in a real-world web application context. Log in with the administrator's user account using SQL Injection
...
#!/usr/bin/env python3
"""
Automated solver for: Login Admin (SQL)
Category: Injection
"""
...
def solve_challenge():
    """Automated solution for Login Admin (SQL)"""

    print(f"[*] Starting challenge: Login Admin (SQL)")

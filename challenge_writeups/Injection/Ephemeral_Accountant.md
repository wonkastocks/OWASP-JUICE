# Ephemeral Accountant - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Ephemeral Accountant
**Category:** Injection
**Difficulty:** ⭐⭐⭐⭐ (4/6)
**Description:** Log in with the (non-existing) accountant without ever registering that user
...
This challenge demonstrates injection vulnerabilities in a real-world web application context. Log in with the (non-existing) accountant without ever registering that user
...
- **Integrity (I):** High - Limited data modification
...
#!/usr/bin/env python3
"""
Automated solver for: Ephemeral Accountant
Category: Injection
"""
...
def solve_challenge():
    """Automated solution for Ephemeral Accountant"""

    print(f"[*] Starting challenge: Ephemeral Accountant")
...
#### Question 1: How does Injection differ from other OWASP Top 10 vulnerabilities?

**Answer:** Injection specifically targets issues with access control and authorization, whereas other vulnerabilities like injection focus on input validation. The key distinction is that Injection assumes proper authentication has occurred but fails to enforce proper authorization checks.

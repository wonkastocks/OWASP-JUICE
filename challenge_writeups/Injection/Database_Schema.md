# Database Schema - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Database Schema
**Category:** Injection
**Difficulty:** ⭐⭐⭐ (3/6)
...
This challenge demonstrates injection vulnerabilities in a real-world web application context. Exfiltrate the entire DB schema definition via SQL Injection
...
#!/usr/bin/env python3
"""
Automated solver for: Database Schema
Category: Injection
"""
...
def solve_challenge():
    """Automated solution for Database Schema"""

    print(f"[*] Starting challenge: Database Schema")

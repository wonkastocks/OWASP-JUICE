# Login Bender (SQL) - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Login Bender (SQL)
**Category:** Injection
**Difficulty:** ⭐⭐⭐ (3/6)
**Description:** Log in with Bender's user account using SQL Injection
...
This challenge demonstrates injection vulnerabilities in a real-world web application context. Log in with Bender's user account using SQL Injection
...
#!/usr/bin/env python3
"""
Automated solver for: Login Bender (SQL)
Category: Injection
"""
...
def solve_challenge():
    """Automated solution for Login Bender (SQL)"""

    print(f"[*] Starting challenge: Login Bender (SQL)")

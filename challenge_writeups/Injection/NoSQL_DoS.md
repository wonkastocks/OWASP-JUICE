# NoSQL DoS - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** NoSQL DoS
**Category:** Injection
**Difficulty:** ⭐⭐⭐⭐ (4/6)
**Description:** Let the server sleep for some time via NoSQL Injection
...
This challenge demonstrates injection vulnerabilities in a real-world web application context. Let the server sleep for some time via NoSQL Injection
...
#!/usr/bin/env python3
"""
Automated solver for: NoSQL DoS
Category: Injection
"""
...
def solve_challenge():
    """Automated solution for NoSQL DoS"""

    print(f"[*] Starting challenge: NoSQL DoS")

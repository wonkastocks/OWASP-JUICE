# Login Jim (SQL) - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Login Jim (SQL)
**Category:** Injection
**Difficulty:** ⭐⭐⭐ (3/6)
**Description:** Log in with Jim's user account using SQL Injection
...
This challenge demonstrates injection vulnerabilities in a real-world web application context. Log in with Jim's user account using SQL Injection
...
#!/usr/bin/env python3
"""
Automated solver for: Login Jim (SQL)
Category: Injection
"""
...
def solve_challenge():
    """Automated solution for Login Jim (SQL)"""

    print(f"[*] Starting challenge: Login Jim (SQL)")

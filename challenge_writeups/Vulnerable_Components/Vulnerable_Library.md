# Vulnerable Library - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Vulnerable Library
**Category:** Vulnerable Components
**Difficulty:** ⭐⭐⭐⭐ (4/6)
**Description:** Inform the shop about a vulnerable library it is using
...
This challenge demonstrates vulnerable components vulnerabilities in a real-world web application context. Inform the shop about a vulnerable library it is using
...
#!/usr/bin/env python3
"""
Automated solver for: Vulnerable Library
Category: Vulnerable Components
"""
...
def solve_challenge():
    """Automated solution for Vulnerable Library"""

    print(f"[*] Starting challenge: Vulnerable Library")

# Reflected XSS - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates xss (cross-site scripting) vulnerabilities in a real-world web application context. Perform a reflected XSS attack
...
#!/usr/bin/env python3
"""
Automated solver for: Reflected XSS
Category: XSS (Cross-Site Scripting)
"""
...
def solve_challenge():
    """Automated solution for Reflected XSS"""

    print(f"[*] Starting challenge: Reflected XSS")

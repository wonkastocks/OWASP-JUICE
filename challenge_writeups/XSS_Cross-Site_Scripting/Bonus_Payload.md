# Bonus Payload - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Bonus Payload
...
This challenge demonstrates xss (cross-site scripting) vulnerabilities in a real-world web application context. Use the bonus payload in the DOM XSS challenge
...
#!/usr/bin/env python3
"""
Automated solver for: Bonus Payload
Category: XSS (Cross-Site Scripting)
"""
...
def solve_challenge():
    """Automated solution for Bonus Payload"""

    print(f"[*] Starting challenge: Bonus Payload")

# View Basket - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates broken access control vulnerabilities in a real-world web application context. View another user's shopping basket
...
#!/usr/bin/env python3
"""
Automated solver for: View Basket
Category: Broken Access Control
"""
...
def solve_challenge():
    """Automated solution for View Basket"""

    print(f"[*] Starting challenge: View Basket")

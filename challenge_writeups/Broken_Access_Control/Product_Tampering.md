# Product Tampering - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Product Tampering
**Category:** Broken Access Control
**Difficulty:** ⭐⭐⭐ (3/6)
**Description:** Change the href of the link within the OWASP SSL Advanced Forensic Tool (O-Saft) product description
...
This challenge demonstrates broken access control vulnerabilities in a real-world web application context. Change the href of the link within the OWASP SSL Advanced Forensic Tool (O-Saft) product description
...
#!/usr/bin/env python3
"""
Automated solver for: Product Tampering
Category: Broken Access Control
"""
...
def solve_challenge():
    """Automated solution for Product Tampering"""

    print(f"[*] Starting challenge: Product Tampering")

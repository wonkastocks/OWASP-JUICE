# Forged Feedback - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Forged Feedback
**Category:** Broken Access Control
**Difficulty:** ⭐⭐⭐ (3/6)
**Description:** Post feedback in another user's name
...
This challenge demonstrates broken access control vulnerabilities in a real-world web application context. Post feedback in another user's name
...
#!/usr/bin/env python3
"""
Automated solver for: Forged Feedback
Category: Broken Access Control
"""
...
def solve_challenge():
    """Automated solution for Forged Feedback"""

    print(f"[*] Starting challenge: Forged Feedback")

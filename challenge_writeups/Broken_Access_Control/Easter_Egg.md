# Easter Egg - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Easter Egg
...
This challenge demonstrates broken access control vulnerabilities in a real-world web application context. Find the hidden easter egg
...
#!/usr/bin/env python3
"""
Automated solver for: Easter Egg
Category: Broken Access Control
"""
...
def solve_challenge():
    """Automated solution for Easter Egg"""

    print(f"[*] Starting challenge: Easter Egg")

# Five-Star Feedback - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates broken access control vulnerabilities in a real-world web application context. Get rid of all 5-star customer feedback
...
#!/usr/bin/env python3
"""
Automated solver for: Five-Star Feedback
Category: Broken Access Control
"""
...
def solve_challenge():
    """Automated solution for Five-Star Feedback"""

    print(f"[*] Starting challenge: Five-Star Feedback")

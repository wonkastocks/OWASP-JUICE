# Manipulate Basket - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Manipulate Basket
...
This challenge demonstrates broken access control vulnerabilities in a real-world web application context. Put an additional product into another user's shopping basket
...
#!/usr/bin/env python3
"""
Automated solver for: Manipulate Basket
Category: Broken Access Control
"""
...
def solve_challenge():
    """Automated solution for Manipulate Basket"""

    print(f"[*] Starting challenge: Manipulate Basket")

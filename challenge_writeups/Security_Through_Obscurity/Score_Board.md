# Score Board - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates security through obscurity vulnerabilities in a real-world web application context. Find the carefully hidden 'Score Board' page
...
#!/usr/bin/env python3
"""
Automated solver for: Score Board
Category: Security Through Obscurity
"""
...
def solve_challenge():
    """Automated solution for Score Board"""

    print(f"[*] Starting challenge: Score Board")

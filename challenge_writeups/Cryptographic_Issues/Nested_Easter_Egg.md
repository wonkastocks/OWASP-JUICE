# Nested Easter Egg - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Nested Easter Egg
**Category:** Cryptographic Issues
**Difficulty:** ⭐⭐⭐⭐ (4/6)
**Description:** Apply advanced cryptanalysis to find the real easter egg

---

## 1. Introduction & Vulnerability Explanation

### What is Cryptographic Issues?
...
This challenge demonstrates cryptographic issues vulnerabilities in a real-world web application context. Apply advanced cryptanalysis to find the real easter egg

---

## 2. CVSS Score & Severity

**CVSS v3.1 Score:** 7.9 (HIGH)
...
#!/usr/bin/env python3
"""
Automated solver for: Nested Easter Egg
Category: Cryptographic Issues
"""
...
def solve_challenge():
    """Automated solution for Nested Easter Egg"""

    print(f"[*] Starting challenge: Nested Easter Egg")
...
#### Question 1: How does Cryptographic Issues differ from other OWASP Top 10 vulnerabilities?

**Answer:** Cryptographic Issues specifically targets issues with access control and authorization, whereas other vulnerabilities like injection focus on input validation. The key distinction is that Cryptographic Issues assumes proper authentication has occurred but fails to enforce proper authorization checks.

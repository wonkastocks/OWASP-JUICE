# Unsigned JWT - OWASP Juice Shop Challenge Writeup
...
**Difficulty:** ⭐⭐⭐⭐⭐ (5/6)
**Description:** Forge an unsigned JWT token
...
This challenge demonstrates cryptographic issues vulnerabilities in a real-world web application context. Forge an unsigned JWT token
...
#!/usr/bin/env python3
"""
Automated solver for: Unsigned JWT
Category: Cryptographic Issues
"""
...
def solve_challenge():
    """Automated solution for Unsigned JWT"""

    print(f"[*] Starting challenge: Unsigned JWT")

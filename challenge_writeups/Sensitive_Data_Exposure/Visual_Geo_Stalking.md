# Visual Geo Stalking - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Visual Geo Stalking
**Category:** Sensitive Data Exposure
**Difficulty:** ⭐⭐ (2/6)
**Description:** Determine the answer to Emma's security question by looking at an upload of her to the Photo Wall
...
This challenge demonstrates sensitive data exposure vulnerabilities in a real-world web application context. Determine the answer to Emma's security question by looking at an upload of her to the Photo Wall
...
#!/usr/bin/env python3
"""
Automated solver for: Visual Geo Stalking
Category: Sensitive Data Exposure
"""
...
def solve_challenge():
    """Automated solution for Visual Geo Stalking"""

    print(f"[*] Starting challenge: Visual Geo Stalking")
...
#### Question 1: How does Sensitive Data Exposure differ from other OWASP Top 10 vulnerabilities?

**Answer:** Sensitive Data Exposure specifically targets issues with access control and authorization, whereas other vulnerabilities like injection focus on input validation. The key distinction is that Sensitive Data Exposure assumes proper authentication has occurred but fails to enforce proper authorization checks.

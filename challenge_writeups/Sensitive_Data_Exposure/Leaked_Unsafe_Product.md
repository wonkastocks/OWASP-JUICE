# Leaked Unsafe Product - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Leaked Unsafe Product
**Category:** Sensitive Data Exposure
**Difficulty:** ⭐⭐⭐⭐ (4/6)
**Description:** Inform the development team about a danger to some of their customers
...
This challenge demonstrates sensitive data exposure vulnerabilities in a real-world web application context. Inform the development team about a danger to some of their customers
...
#!/usr/bin/env python3
"""
Automated solver for: Leaked Unsafe Product
Category: Sensitive Data Exposure
"""
...
def solve_challenge():
    """Automated solution for Leaked Unsafe Product"""

    print(f"[*] Starting challenge: Leaked Unsafe Product")

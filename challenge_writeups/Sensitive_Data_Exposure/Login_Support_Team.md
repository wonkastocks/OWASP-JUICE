# Login Support Team - OWASP Juice Shop Challenge Writeup
...
**Difficulty:** ⭐⭐⭐⭐⭐⭐ (6/6)
**Description:** Log in with the support team's original user credentials
...
This challenge demonstrates sensitive data exposure vulnerabilities in a real-world web application context. Log in with the support team's original user credentials
...
#!/usr/bin/env python3
"""
Automated solver for: Login Support Team
Category: Sensitive Data Exposure
"""
...
def solve_challenge():
    """Automated solution for Login Support Team"""

    print(f"[*] Starting challenge: Login Support Team")

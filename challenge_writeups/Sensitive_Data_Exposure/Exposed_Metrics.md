# Exposed Metrics - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates sensitive data exposure vulnerabilities in a real-world web application context. Find the endpoint that serves usage data to be scraped by a popular monitoring system
...
#!/usr/bin/env python3
"""
Automated solver for: Exposed Metrics
Category: Sensitive Data Exposure
"""
...
def solve_challenge():
    """Automated solution for Exposed Metrics"""

    print(f"[*] Starting challenge: Exposed Metrics")

# Meta Geo Stalking - OWASP Juice Shop Challenge Writeup
...
**Difficulty:** ⭐⭐ (2/6)
**Description:** Determine the answer to John's security question by looking at an upload of him to the Photo Wall
...
This challenge demonstrates sensitive data exposure vulnerabilities in a real-world web application context. Determine the answer to John's security question by looking at an upload of him to the Photo Wall
...
#!/usr/bin/env python3
"""
Automated solver for: Meta Geo Stalking
Category: Sensitive Data Exposure
"""
...
def solve_challenge():
    """Automated solution for Meta Geo Stalking"""

    print(f"[*] Starting challenge: Meta Geo Stalking")

# Arbitrary File Write - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates security misconfiguration vulnerabilities in a real-world web application context. Overwrite the Legal Information file
...
#!/usr/bin/env python3
"""
Automated solver for: Arbitrary File Write
Category: Security Misconfiguration
"""
...
def solve_challenge():
    """Automated solution for Arbitrary File Write"""

    print(f"[*] Starting challenge: Arbitrary File Write")

# Security Policy - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Security Policy
...
This challenge demonstrates security misconfiguration vulnerabilities in a real-world web application context. Behave like any "white-hat" should before getting into the action
...
#!/usr/bin/env python3
"""
Automated solver for: Security Policy
Category: Security Misconfiguration
"""
...
def solve_challenge():
    """Automated solution for Security Policy"""

    print(f"[*] Starting challenge: Security Policy")

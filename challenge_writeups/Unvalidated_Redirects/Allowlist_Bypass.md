# Allowlist Bypass - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Allowlist Bypass
...
This challenge demonstrates unvalidated redirects vulnerabilities in a real-world web application context. Enforce a redirect to a page you are not supposed to redirect to
...
#!/usr/bin/env python3
"""
Automated solver for: Allowlist Bypass
Category: Unvalidated Redirects
"""
...
def solve_challenge():
    """Automated solution for Allowlist Bypass"""

    print(f"[*] Starting challenge: Allowlist Bypass")

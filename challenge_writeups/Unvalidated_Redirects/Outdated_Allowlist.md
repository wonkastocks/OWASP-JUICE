# Outdated Allowlist - OWASP Juice Shop Challenge Writeup
...
**Difficulty:** ⭐ (1/6)
**Description:** Let us redirect you to a donation site
...
This challenge demonstrates unvalidated redirects vulnerabilities in a real-world web application context. Let us redirect you to a donation site

---

## 2. CVSS Score & Severity

**CVSS v3.1 Score:** 5.1 (MEDIUM)
...
#!/usr/bin/env python3
"""
Automated solver for: Outdated Allowlist
Category: Unvalidated Redirects
"""
...
def solve_challenge():
    """Automated solution for Outdated Allowlist"""

    print(f"[*] Starting challenge: Outdated Allowlist")
...
#### Question 1: How does Unvalidated Redirects differ from other OWASP Top 10 vulnerabilities?

**Answer:** Unvalidated Redirects specifically targets issues with access control and authorization, whereas other vulnerabilities like injection focus on input validation. The key distinction is that Unvalidated Redirects assumes proper authentication has occurred but fails to enforce proper authorization checks.

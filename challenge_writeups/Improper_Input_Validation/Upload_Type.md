# Upload Type - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Upload Type
**Category:** Improper Input Validation
**Difficulty:** ⭐⭐⭐ (3/6)
**Description:** Upload a file of a type that should not be accepted
...
This challenge demonstrates improper input validation vulnerabilities in a real-world web application context. Upload a file of a type that should not be accepted
...
#!/usr/bin/env python3
"""
Automated solver for: Upload Type
Category: Improper Input Validation
"""
...
def solve_challenge():
    """Automated solution for Upload Type"""

    print(f"[*] Starting challenge: Upload Type")

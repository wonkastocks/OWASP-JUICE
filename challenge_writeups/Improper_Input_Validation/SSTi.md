# SSTi - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates improper input validation vulnerabilities in a real-world web application context. Infect the server with juicy malware by abusing arbitrary command execution
...
def solve_challenge():
    """Automated solution for SSTi"""

    print(f"[*] Starting challenge: SSTi")

# Zero Stars - OWASP Juice Shop Challenge Writeup
...
**Difficulty:** ⭐ (1/6)
**Description:** Give a feedback with a rating of 0 stars
...
This challenge demonstrates improper input validation vulnerabilities in a real-world web application context. Give a feedback with a rating of 0 stars
...
#!/usr/bin/env python3
"""
Automated solver for: Zero Stars
Category: Improper Input Validation
"""
...
def solve_challenge():
    """Automated solution for Zero Stars"""

    print(f"[*] Starting challenge: Zero Stars")

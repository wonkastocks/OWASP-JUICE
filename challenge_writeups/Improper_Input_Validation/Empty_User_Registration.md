# Empty User Registration - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates improper input validation vulnerabilities in a real-world web application context. Register a user with an empty email and password
...
#!/usr/bin/env python3
"""
Automated solver for: Empty User Registration
Category: Improper Input Validation
"""
...
def solve_challenge():
    """Automated solution for Empty User Registration"""

    print(f"[*] Starting challenge: Empty User Registration")

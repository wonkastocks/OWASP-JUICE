# NFT Takeover - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** NFT Takeover
...
This challenge demonstrates improper input validation vulnerabilities in a real-world web application context. Take over the wallet containing our official Soul Bound Token (NFT)
...
#!/usr/bin/env python3
"""
Automated solver for: NFT Takeover
Category: Improper Input Validation
"""
...
def solve_challenge():
    """Automated solution for NFT Takeover"""

    print(f"[*] Starting challenge: NFT Takeover")

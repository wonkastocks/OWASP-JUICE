# Poison Null Byte - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Poison Null Byte
**Category:** Improper Input Validation
**Difficulty:** ⭐⭐⭐⭐ (4/6)
**Description:** Bypass a security control with a Poison Null Byte
...
This challenge demonstrates improper input validation vulnerabilities in a real-world web application context. Bypass a security control with a Poison Null Byte
...
#!/usr/bin/env python3
"""
Automated solver for: Poison Null Byte
Category: Improper Input Validation
"""
...
def solve_challenge():
    """Automated solution for Poison Null Byte"""

    print(f"[*] Starting challenge: Poison Null Byte")
...
#### Question 1: How does Improper Input Validation differ from other OWASP Top 10 vulnerabilities?

**Answer:** Improper Input Validation specifically targets issues with access control and authorization, whereas other vulnerabilities like injection focus on input validation. The key distinction is that Improper Input Validation assumes proper authentication has occurred but fails to enforce proper authorization checks.

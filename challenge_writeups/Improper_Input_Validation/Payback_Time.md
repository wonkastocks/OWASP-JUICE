# Payback Time - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates improper input validation vulnerabilities in a real-world web application context. Place an order that makes you rich
...
#!/usr/bin/env python3
"""
Automated solver for: Payback Time
Category: Improper Input Validation
"""
...
def solve_challenge():
    """Automated solution for Payback Time"""

    print(f"[*] Starting challenge: Payback Time")

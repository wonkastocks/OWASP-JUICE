# Admin Registration - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Admin Registration
...
This challenge demonstrates improper input validation vulnerabilities in a real-world web application context. Register as a user with administrator privileges
...
#!/usr/bin/env python3
"""
Automated solver for: Admin Registration
Category: Improper Input Validation
"""
...
def solve_challenge():
    """Automated solution for Admin Registration"""

    print(f"[*] Starting challenge: Admin Registration")

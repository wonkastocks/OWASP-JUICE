# Reset Password - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Reset Password
**Category:** Broken Authentication
**Difficulty:** ⭐⭐⭐⭐ (4/6)
**Description:** Reset Jim's password via the Forgot Password mechanism
...
This challenge demonstrates broken authentication vulnerabilities in a real-world web application context. Reset Jim's password via the Forgot Password mechanism
...
#!/usr/bin/env python3
"""
Automated solver for: Reset Password
Category: Broken Authentication
"""
...
def solve_challenge():
    """Automated solution for Reset Password"""

    print(f"[*] Starting challenge: Reset Password")

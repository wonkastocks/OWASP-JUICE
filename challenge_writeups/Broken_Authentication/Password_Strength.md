# Password Strength - OWASP Juice Shop Challenge Writeup
...
**Difficulty:** ⭐⭐ (2/6)
**Description:** Log in with the administrator's user credentials without SQL Injection
...
This challenge demonstrates broken authentication vulnerabilities in a real-world web application context. Log in with the administrator's user credentials without SQL Injection
...
#!/usr/bin/env python3
"""
Automated solver for: Password Strength
Category: Broken Authentication
"""
...
def solve_challenge():
    """Automated solution for Password Strength"""

    print(f"[*] Starting challenge: Password Strength")

# Login Jim - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Login Jim
...
This challenge demonstrates broken authentication vulnerabilities in a real-world web application context. Log in with Jim's user account
...
#!/usr/bin/env python3
"""
Automated solver for: Login Jim
Category: Broken Authentication
"""
...
def solve_challenge():
    """Automated solution for Login Jim"""

    print(f"[*] Starting challenge: Login Jim")

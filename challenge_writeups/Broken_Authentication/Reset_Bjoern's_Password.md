# Reset Bjoern's Password - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** Reset Bjoern's Password
**Category:** Broken Authentication
**Difficulty:** ⭐⭐⭐⭐⭐ (5/6)
**Description:** Reset Bjoern's password via the Forgot Password mechanism
...
This challenge demonstrates broken authentication vulnerabilities in a real-world web application context. Reset Bjoern's password via the Forgot Password mechanism
...
- **Integrity (I):** High - Complete data modification
...
#!/usr/bin/env python3
"""
Automated solver for: Reset Bjoern's Password
Category: Broken Authentication
"""
...
def solve_challenge():
    """Automated solution for Reset Bjoern's Password"""

    print(f"[*] Starting challenge: Reset Bjoern's Password")
...
#### Question 1: How does Broken Authentication differ from other OWASP Top 10 vulnerabilities?

**Answer:** Broken Authentication specifically targets issues with access control and authorization, whereas other vulnerabilities like injection focus on input validation. The key distinction is that Broken Authentication assumes proper authentication has occurred but fails to enforce proper authorization checks.

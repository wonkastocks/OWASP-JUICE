# Login Admin - OWASP Juice Shop Challenge Writeup
...
This challenge demonstrates broken authentication vulnerabilities in a real-world web application context. Log in with the administrator's user account
...
#!/usr/bin/env python3
"""
Automated solver for: Login Admin
Category: Broken Authentication
"""
...
def solve_challenge():
    """Automated solution for Login Admin"""

    print(f"[*] Starting challenge: Login Admin")

# XXE DoS - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** XXE DoS
...
This challenge demonstrates xxe (xml external entities) vulnerabilities in a real-world web application context. Give the server something to chew on for quite a while
...
def solve_challenge():
    """Automated solution for XXE DoS"""

    print(f"[*] Starting challenge: XXE DoS")

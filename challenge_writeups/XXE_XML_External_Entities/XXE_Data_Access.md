# XXE Data Access - OWASP Juice Shop Challenge Writeup

## Challenge Information

**Challenge Name:** XXE Data Access
**Category:** XXE (XML External Entities)
**Difficulty:** ⭐⭐⭐⭐ (4/6)
**Description:** Retrieve the content of C:\Windows\system.ini or /etc/passwd from the server
...
This challenge demonstrates xxe (xml external entities) vulnerabilities in a real-world web application context. Retrieve the content of C:\Windows\system.ini or /etc/passwd from the server
...
#!/usr/bin/env python3
"""
Automated solver for: XXE Data Access
Category: XXE (XML External Entities)
"""
...
def solve_challenge():
    """Automated solution for XXE Data Access"""

    print(f"[*] Starting challenge: XXE Data Access")
...
#### Question 1: How does XXE (XML External Entities) differ from other OWASP Top 10 vulnerabilities?

**Answer:** XXE (XML External Entities) specifically targets issues with access control and authorization, whereas other vulnerabilities like injection focus on input validation. The key distinction is that XXE (XML External Entities) assumes proper authentication has occurred but fails to enforce proper authorization checks.
